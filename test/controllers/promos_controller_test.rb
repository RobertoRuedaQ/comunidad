...
class PromosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create promo" do
    assert_difference('Promo.count') do
      post promos_url, params: { promo: { hobbies_id: @promo.hobbies_id, image: @promo.image, url: @promo.url } }
    end
  ...
  test "should update promo" do
    patch promo_url(@promo), params: { promo: { hobbies_id: @promo.hobbies_id, image: @promo.image, url: @promo.url } }
