...
class AdvertisementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create advertisement" do
    assert_difference('Advertisement.count') do
      post advertisements_url, params: { advertisement: { amount: @advertisement.amount, description: @advertisement.description, image: @advertisement.image, tittle: @advertisement.tittle, user_id: @advertisement.user_id } }
    end
  ...
  test "should update advertisement" do
    patch advertisement_url(@advertisement), params: { advertisement: { amount: @advertisement.amount, description: @advertisement.description, image: @advertisement.image, tittle: @advertisement.tittle, user_id: @advertisement.user_id } }
