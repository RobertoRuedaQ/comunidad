...
class ApartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create apartment" do
    assert_difference('Apartment.count') do
      post apartments_url, params: { apartment: { area: @apartment.area, bikes_parking: @apartment.bikes_parking, block: @apartment.block, number: @apartment.number, parking_lots: @apartment.parking_lots, werehouse_id: @apartment.werehouse_id } }
    end
  ...
  test "should update apartment" do
    patch apartment_url(@apartment), params: { apartment: { area: @apartment.area, bikes_parking: @apartment.bikes_parking, block: @apartment.block, number: @apartment.number, parking_lots: @apartment.parking_lots, werehouse_id: @apartment.werehouse_id } }
