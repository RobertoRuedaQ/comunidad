...
class DecisionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create decision" do
    assert_difference('Decision.count') do
      post decisions_url, params: { decision: { description: @decision.description, tittle: @decision.tittle } }
    end
  ...
  test "should update decision" do
    patch decision_url(@decision), params: { decision: { description: @decision.description, tittle: @decision.tittle } }
