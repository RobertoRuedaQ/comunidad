...
ActiveRecord::Schema.define(version: 20171221143345) do
  ...
  create_table "bussinesses", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["email"], name: "index_bussinesses_on_email", unique: true
    t.index ["reset_password_token"], name: "index_bussinesses_on_reset_password_token", unique: true
  end
  ...
  create_table "orders", force: :cascade do |t|
    ...
    t.index ["bussiness_id"], name: "index_orders_on_bussiness_id"
